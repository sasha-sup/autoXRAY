...
# Удаляем stale sub-файлы предыдущих установок (имя = 20-символьный токен)
find "$WEB_PATH" -maxdepth 1 -type f -regextype posix-extended \
    -regex ".*/[A-Za-z0-9]{20}\.(json|html)$" -delete 2>/dev/null
